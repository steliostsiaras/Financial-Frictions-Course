...
if T_flag
    T = GK.static_resid_tt(T, y, x, params);
end
residual = zeros(49, 1);
lhs = y(2);
...
residual(13) = lhs - rhs;
lhs = y(18);
rhs = 1-params(8)+params(8)*params(7)*y(15);
residual(14) = lhs - rhs;
lhs = y(16)*y(12);
rhs = y(15)*y(10);
residual(15) = lhs - rhs;
...
residual(16) = lhs - rhs;
lhs = y(15);
rhs = y(6)*y(17)*y(18)/(params(7)-y(17)*y(18)*y(21));
residual(17) = lhs - rhs;
lhs = y(10);
rhs = y(16)*y(12)*y(7)*(params(8)+params(9))-y(14)*y(6)*params(8);
residual(18) = lhs - rhs;
lhs = y(7);
rhs = y(30)*(y(9)+(1-params(6))*y(12))/y(12);
residual(19) = lhs - rhs;
lhs = y(1);
rhs = y(4)+y(5)+y(20);
residual(20) = lhs - rhs;
...
residual(24) = lhs - rhs;
lhs = log(y(30));
rhs = log(y(30))*params(13)-x(3);
residual(25) = lhs - rhs;
lhs = log(y(28));
rhs = log(y(28))*params(12)+x(1);
residual(26) = lhs - rhs;
lhs = log(y(29));
rhs = log(y(29))*params(14)+x(2);
residual(27) = lhs - rhs;
lhs = y(22);
rhs = y(4)+y(5);
residual(28) = lhs - rhs;
