...
if T_flag
    T = GK.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(49, 1);
lhs = y(11);
...
rhs = y(25)*y(39);
residual(5) = lhs - rhs;
lhs = y(21)*(1-y(34)-y(33)*y(35))+y(63)*y(62)*y(67)*T(1);
rhs = 1;
residual(6) = lhs - rhs;
lhs = y(10);
rhs = T(3)*T(4);
...
residual(13) = lhs - rhs;
lhs = y(27);
rhs = 1-params(8)+params(8)*params(7)*y(24);
residual(14) = lhs - rhs;
lhs = y(25)*y(21);
rhs = y(24)*y(19);
residual(15) = lhs - rhs;
...
residual(16) = lhs - rhs;
lhs = y(24);
rhs = y(63)*y(64)*y(59)/(params(7)-y(63)*y(64)*y(65));
residual(17) = lhs - rhs;
lhs = y(19);
rhs = y(16)*y(4)*y(6)*(params(8)+params(9))-y(15)*params(8)*y(5);
residual(18) = lhs - rhs;
lhs = y(16);
rhs = y(39)*(y(18)+(1-params(6))*y(21))/y(4);
residual(19) = lhs - rhs;
lhs = y(10);
rhs = y(13)+y(14)+y(29);
residual(20) = lhs - rhs;
...
residual(21) = lhs - rhs;
lhs = y(29);
rhs = y(38)*params(11)*(steady_state(1));
residual(22) = lhs - rhs;
lhs = y(36);
rhs = y(60)-y(15);
residual(23) = lhs - rhs;
