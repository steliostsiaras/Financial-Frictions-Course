...
cd '/Users/alabama/Documents/GitHub/Financial_Firctions_Course_EUI/Financial-Frictions-Course/Part3_Limited_Commitment/codes/'

dynare GK
result(1) = oo_.irfs;

% Here change your path to where you have stored BGGflexi
cd '/Users/alabama/Documents/GitHub/Financial_Firctions_Course_EUI/Financial-Frictions-Course/Part3_Limited_Commitment/exercise/'
dynare GK_calib
result(2) = oo_.irfs;

%%
figure('Name','Capital Quality Shock under BGG NK and BGG RBC'); 
...
sh=subplot(3,3,9);
p= [.72, .15 0.2 0.15];
lh=legend(sh,[ph1;ph2],{'non calibrated','calibrated'},'FontWeight','bold','FontSize',20);
set(lh,'position',p);
axis(sh,'off');
