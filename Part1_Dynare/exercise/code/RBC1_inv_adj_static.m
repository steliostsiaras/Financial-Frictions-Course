function [residual, g1, g2, g3] = RBC1_inv_adj_static(y, x, params)
%
...
T41 = y(11)*T40;
T44 = y(9)^(1-params(5));
T72 = 1-params(15)*(y(20)-1)^2;
T85 = y(20)^2;
T87 = y(21)*(y(20)-1)*2*params(15)*T85;
lhs =y(1);
...
rhs =1;
residual(12)= lhs-rhs;
lhs =y(21)*(T72-(y(20)-1)*params(15)*2*y(20))+T87*y(19);
rhs =1;
residual(13)= lhs-rhs;
lhs =y(19);
...
T174 = 1/y(11)-1/(y(11));
  ...
  g1(9,17)=1;
  g1(9,18)=(-(1/y(21)));
  g1(9,21)=(-(((1-params(8))*y(21)-(y(18)+(1-params(8))*y(21)))/(y(21)*y(21))));
  g1(10,5)=(-1);
  g1(10,8)=1;
  g1(10,10)=(-1);
  g1(10,12)=(-1);
  ...
  g1(11,10)=(-T72);
  g1(11,20)=(-(y(10)*(-(params(15)*2*(y(20)-1)))));
  g1(12,20)=1;
  g1(13,19)=T87;
  g1(13,20)=y(21)*((-(params(15)*2*(y(20)-1)))-(params(15)*2*y(20)+(y(20)-1)*2*params(15)))+y(19)*y(21)*(2*params(15)*T85+2*y(20)*(y(20)-1)*2*params(15));
  g1(13,21)=T72-(y(20)-1)*params(15)*2*y(20)+(y(20)-1)*2*params(15)*T85*y(19);
  g1(14,19)=1;
  g1(15,4)=(-y(19));
  g1(15,17)=y(19);
  g1(15,19)=y(17)-y(4);
  ...
  g1(17,12)=(-1);
  g1(17,13)=1;
  g1(18,11)=T174-params(9)*T174;
  g1(19,8)=(-((-y(9))/(y(8)*y(8))));
  g1(19,9)=(-(1/y(8)));
  g1(19,14)=1;
  g1(20,8)=(-((-y(10))/(y(8)*y(8))));
  g1(20,10)=(-(1/y(8)));
  g1(20,15)=1;
  g1(21,5)=(-(1/y(8)));
  g1(21,8)=(-((-y(5))/(y(8)*y(8))));
