...
i=2;
dynare BGGflexi noclearall 
yrS (:,i)       = oo_.irfs.YY_epsilonsigmae;
crS (:,i)       = oo_.irfs.CC_epsilonsigmae;
irS (:,i)       = oo_.irfs.II_epsilonsigmae;
krS (:,i)       = oo_.irfs.KK_epsilonsigmae;
labrS(:,i)      = oo_.irfs.LabLab_epsilonsigmae;
creditrS(:,i)   = oo_.irfs.LeLe_epsilonsigmae;
netwrS (:,i)    = oo_.irfs.NeNe_epsilonsigmae;
phierS (:,i)    = oo_.irfs.phiephie_epsilonsigmae;
rS(:,i)         = oo_.irfs.RR_epsilonsigmae;
defaultS(:,i)   = oo_.irfs.bankrupt_epsilonsigmae;
premrS(:,i)     = oo_.irfs.spreadspread_epsilonsigmae;
%%
