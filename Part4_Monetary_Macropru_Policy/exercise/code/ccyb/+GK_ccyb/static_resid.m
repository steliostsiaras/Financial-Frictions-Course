...
if T_flag
    T = GK_ccyb.static_resid_tt(T, y, x, params);
end
residual = zeros(52, 1);
lhs = y(2);
...
residual(16) = lhs - rhs;
lhs = y(28);
rhs = params(7)+params(12)*(y(16)*y(12)/(y(1)+y(1)+y(1)+y(1))-(y(12))*(y(16))/(4*(y(1))));
residual(17) = lhs - rhs;
lhs = y(15);
...
residual(25) = lhs - rhs;
lhs = log(y(31));
rhs = log(y(31))*params(14)-x(3);
residual(26) = lhs - rhs;
lhs = log(y(29));
rhs = log(y(29))*params(13)+x(1);
residual(27) = lhs - rhs;
lhs = log(y(30));
rhs = log(y(30))*params(15)+x(2);
residual(28) = lhs - rhs;
lhs = y(22);
rhs = y(4)+y(5);
residual(29) = lhs - rhs;
