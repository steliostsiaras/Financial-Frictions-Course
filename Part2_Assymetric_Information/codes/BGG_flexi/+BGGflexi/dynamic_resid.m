...
residual(17) = lhs - rhs;
lhs = y(21);
rhs = y(31)*(y(20)+(1-params(6))*y(30))/y(7);
residual(18) = lhs - rhs;
lhs = y(17)*y(30);
rhs = y(24)+y(22);
residual(19) = lhs - rhs;
lhs = y(22);
rhs = y(2)*y(7)*y(21)*(y(35)+params(7))*(1-y(46));
residual(20) = lhs - rhs;
lhs = y(25);
rhs = y(2)*y(7)*y(21)*(1-y(46))*(1-params(7))*(1-y(35));
residual(21) = lhs - rhs;
lhs = y(22)*y(23);
rhs = y(17)*y(30);
residual(22) = lhs - rhs;
...
residual(23) = lhs - rhs;
lhs = y(28);
rhs = y(4)*(y(2)*y(7)-y(5))/(y(2)*y(21)*y(7));
residual(24) = lhs - rhs;
lhs = y(26);
...
residual(27) = lhs - rhs;
lhs = y(16);
rhs = y(29)+y(11)+y(25)+y(32)+y(2)*y(7)*y(21)*y(45)*y(38);
residual(28) = lhs - rhs;
lhs = y(32);
rhs = y(33);
residual(29) = lhs - rhs;
...
residual(31) = lhs - rhs;
lhs = log(y(19));
rhs = 0.75*log(y(3))+x(it_, 1);
residual(32) = lhs - rhs;
lhs = log(y(40));
rhs = params(11)*log(y(10))+x(it_, 2);
residual(33) = lhs - rhs;
lhs = log(y(36)/y(37));
rhs = params(10)*log(y(9)/y(37))+x(it_, 4);
residual(34) = lhs - rhs;
lhs = log(y(31));
